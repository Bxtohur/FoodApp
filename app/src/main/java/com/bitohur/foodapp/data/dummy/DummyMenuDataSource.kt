...
class DummyMenuDataSourceImpl() : DummyMenuDataSource {
    override fun getMenus(): List<Menu> = mutableListOf(
        Menu(
            ...
            imageUrl = "https://images.unsplash.com/photo-1592011432621-f7f576f44484?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
        ...
        Menu(
            ...
            imageUrl = "https://images.unsplash.com/photo-1562967914-608f82629710?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2073&q=80",
        ...
        Menu(
            ...
            imageUrl = "https://images.unsplash.com/photo-1674483950016-8ece0632914e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
            location = "Jl. Raya Jatinagara, Jatinagara, Kec. Jatinagara, Kabupaten Ciamis, Jawa Barat"
        ),
        Menu(
            name = "Sate Usus Ayam",
            price = 5000,
            priceFormat = "Rp.5.000",
            ...
            imageUrl = "https://images.unsplash.com/photo-1634871572365-8bc444e6faea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
